...
export default function EmergencySOS() {
  ...
  const actions = [
    { label: 'Call Ambulance', icon: Phone, color: '#FF4D4D', tel: LOCAL_EMERGENCY_NUMBERS.ambulance },
    { label: 'Call Police', icon: ShieldAlert, color: '#4FC3F7', tel: LOCAL_EMERGENCY_NUMBERS.police },
    { label: 'Call Fire Dept.', icon: Flame, color: '#F59E0B', tel: LOCAL_EMERGENCY_NUMBERS.fire },
    { label: 'Share Live Location', icon: MapPin, color: '#8B5CF6', share: true },
  ];
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        <GlassCard className="p-8 text-center mb-8 relative overflow-hidden" hover={false}>
          ...
          <motion.button
            onClick={() => setConfirming({ label: 'Full Emergency Alert', icon: Siren, color: '#FF4D4D' })}
