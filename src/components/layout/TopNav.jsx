      ...
      <div className="glass rounded-xl2 h-16 flex items-center justify-between px-4 md:px-5">
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <span className="relative flex h-8 w-8 items-center justify-center rounded-full bg-emergency shadow-glow">
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <Link to="/profile" aria-label="Profile" className="ml-1">
            <div className="w-9 h-9 rounded-full bg-white/8 border border-emergency/25 flex items-center justify-center font-display text-sm font-semibold">
              AM
            </div>
          </Link>
        </div>
