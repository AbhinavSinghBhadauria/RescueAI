...
const actions = [
  { label: 'Call Ambulance', icon: Phone, color: '#D6472C', tel: '112' },
  { label: 'Police', icon: ShieldAlert, color: '#4A8C8C', tel: '112' },
  { label: 'Fire', icon: Flame, color: '#C4903D', tel: '112' },
  { label: 'Share Location', icon: MapPin, color: '#7A7699', share: true },
  { label: 'Emergency Contacts', icon: Users, color: '#4C9A6A', link: '/sos' },
  { label: 'SOS Message', icon: MessageSquareWarning, color: '#D6472C', link: '/sos' },
];
